...
- Keep compatibility and preference separate: engine/range declarations remain the allowed runtime requirement, while an exact compatible pin is preserved as `nodePreferredVersion`.
